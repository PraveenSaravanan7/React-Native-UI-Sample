...
export const screen_three = ({ navigation }) => {
    return (
        ...
        <ScrollView style={GS.scrollView}>
            <TouchableOpacity onPress={() => {navigation.goBack()}} >
                ...
                <View style={{marginTop:30}} >
                    <TextInput style={GS.input_two} label="Phone number" />
                    {/* <Title style={{color:'gray', fontSize:16, fontWeight:'bold',marginLeft:10}} >Gender</Title>
                   <View >Male</View> */}
                </View>
                <ButtonLg disabled={false} style={{marginTop:20}} onPress={() => {navigation.push("screen_four")}} >Continue</ButtonLg>
